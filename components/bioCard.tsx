...
export default function BioCard(props: ProfileData) {
  ...
  return (
    <div className="flex justify-center">
      <div className="flex flex-col bg-gray-100 max-w-sm shadow-md py-8 px-8 md:px-8 rounded-md hover:bg-gray-300">
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          <div className="flex flex-col text-left">
            ...
            <Link href="/leaderboard">
              <div className="flex justify-around mb-3">
                <div className="text-gray-900 text-xl whitespace-nowrap">
                  {age}
                </div>
                <div className="text-gray-900 text-xl whitespace-nowrap">
                  🎂{birthday}
              ...
              <div className="flex justify-around">
                <div className="text-gray-900 text-xl hover:font-semibold">
                  🐣{twitter}
                </div>
                <div className="text-gray-900 text-xl hover:font-semibold">
                  📧{email}
